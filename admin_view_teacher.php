...
if($_GET['teacher_id'])
{
    ...
    $results=mysqli_query($data,$sql2);
    if($result2)
    {
...
<table border="1px">
    ...
    <tr>
        ...
        <td class="table_td">
            <?php
        echo"
            <a onClick=\"javascript:return confirm('Are you sure to delete?'):\" class ='btn btn-danger' href='delete_teacher.php?teacher_id={$info['id']}'>Delete</a>";
            ?>
        </td>
        <td class="table_td">
            <?php
